...
from Discovery.inductive.variants.im_clean.cuts import sequence as sequence_cut, xor as xor_cut, \
    concurrency as concurrent_cut, loop as loop_cut
from Discovery.inductive.variants.im_clean.fall_throughs import activity_once_per_trace, activity_concurrent, \
    strict_tau_loop, tau_loop
from Discovery.inductive.variants.im_clean.utils import __filter_dfg_on_threshold, __flower
...
from Objects.process_tree import obj as pt
