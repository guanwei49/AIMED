...
associatedTransitionName=['name_10']  ######################
...
def genNet():
    ...
    Replaced_Activity = PetriNet.Transition("name_10", "Replaced_Activity")
    ...
    petri_utils.add_arc_from_to(p_13, Replaced_Activity, net)
    petri_utils.add_arc_from_to(Replaced_Activity, p_14, net)
