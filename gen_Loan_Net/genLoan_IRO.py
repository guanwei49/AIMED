...
associatedTransitionName=['name_11']  ######################
...
def genNet():
    ...
    t_N2 = PetriNet.Transition("name_21", None)
    Added_Acitvity = PetriNet.Transition("name_22", 'Added_Acitvity')
    Verify_repayment_agreement2 = PetriNet.Transition("name_23", "Verify_repayment_agreement")
    Prepare_acceptance_pack2 = PetriNet.Transition("name_24", "Prepare_acceptance_pack")
    t_N3 = PetriNet.Transition("name_25", None)
    ...
    net.transitions.add(t_N2)
    net.transitions.add(Added_Acitvity)
    net.transitions.add(Verify_repayment_agreement2)
    net.transitions.add(Prepare_acceptance_pack2)
    net.transitions.add(t_N3)
    ...
    petri_utils.add_arc_from_to(Send_acceptance_pack, p_13, net)
    ...
    petri_utils.add_arc_from_to(p_14, t_N3, net)
    petri_utils.add_arc_from_to(t_N3, p_21, net)
    petri_utils.add_arc_from_to( p_21,Approve_application, net)
    ...
    petri_utils.add_arc_from_to(Approve_application, p_17, net)
    petri_utils.add_arc_from_to(Approve_application, p_18, net)
    petri_utils.add_arc_from_to(p_17,Prepare_acceptance_pack2, net)
    petri_utils.add_arc_from_to(p_18,Verify_repayment_agreement2, net)
    petri_utils.add_arc_from_to(Prepare_acceptance_pack2, p_19, net)
    petri_utils.add_arc_from_to(Verify_repayment_agreement2, p_20, net)
    petri_utils.add_arc_from_to(p_19,Added_Acitvity, net)
    petri_utils.add_arc_from_to(p_20,Added_Acitvity, net)
    petri_utils.add_arc_from_to(Added_Acitvity, p_16, net)
    petri_utils.add_arc_from_to( p_16,t_N2, net)
    petri_utils.add_arc_from_to(t_N2, p_21, net)
