...
associatedTransitionName=['name_3','name_4','name_5']  ######################
frequent_info = {'p_2': {'name_13': 0.15, 'name_21': 0.85}}##########
...
def genNet():
    ...
    t_N3 = PetriNet.Transition("name_22", None)
    t_N4 = PetriNet.Transition("name_23", None)
    Added_Acitvity = PetriNet.Transition("name_24", 'Added_Acitvity')
    ...
    petri_utils.add_arc_from_to(p_2, t_N2, net)
    petri_utils.add_arc_from_to(t_N2, p_17, net)
    petri_utils.add_arc_from_to(p_17, t_N, net)
    petri_utils.add_arc_from_to(t_N, p_4, net)
    petri_utils.add_arc_from_to(t_N, p_5, net)
    petri_utils.add_arc_from_to(p_5, Added_Acitvity, net)
    petri_utils.add_arc_from_to( Added_Acitvity, p_19,net)
    petri_utils.add_arc_from_to(p_19, Appraise_property, net)
    petri_utils.add_arc_from_to(p_4, Assess_loan_risk, net)

    petri_utils.add_arc_from_to(Assess_loan_risk, p_7, net)
    petri_utils.add_arc_from_to(Appraise_property, p_6, net)
    petri_utils.add_arc_from_to(p_6, t_N3, net)
    petri_utils.add_arc_from_to(p_7, Check_credit_history, net)
    petri_utils.add_arc_from_to(Check_credit_history, p_8, net)

    petri_utils.add_arc_from_to(p_8, t_N3, net)
    petri_utils.add_arc_from_to(t_N3, p_18, net)
    petri_utils.add_arc_from_to(p_18, Assess_eligibility, net)
    petri_utils.add_arc_from_to(Assess_eligibility, p_9, net)
    petri_utils.add_arc_from_to(p_18, t_N4, net)
    petri_utils.add_arc_from_to(t_N4, p_17, net)
