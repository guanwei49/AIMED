...
associatedTransitionName=['name_5','name_4','name_3']  ######################
...
def genNet():
    ...
    Replaced_Activity = PetriNet.Transition("name_4", "Replaced_Activity")
    ...
    net.transitions.add(Replaced_Activity)
    ...
    petri_utils.add_arc_from_to(Appraise_property, p_4, net)
    petri_utils.add_arc_from_to(p_4, Replaced_Activity, net)
    petri_utils.add_arc_from_to(Replaced_Activity, p_7, net)
    petri_utils.add_arc_from_to(p_7, Assess_loan_risk, net)
    petri_utils.add_arc_from_to(p_7, t_N2, net)
    petri_utils.add_arc_from_to(t_N2, p_5, net)
