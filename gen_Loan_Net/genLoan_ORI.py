...
associatedTransitionName=['name_9','name_19','name_8','name_10']  ######################
frequent_info = { 'p_2': {'name_13': 0.15, 'name_20': 0.85},'p_14': {'name_21': 0.15, 'name_17': 0.4,'name_11':0.45}}##########
...
def genNet():
    ...
    petri_utils.add_arc_from_to(p_18, Send_acceptance_pack, net)
    petri_utils.add_arc_from_to(p_12, Send_home_insurance_quote, net)
    petri_utils.add_arc_from_to(Send_home_insurance_quote, p_17, net)
    petri_utils.add_arc_from_to(p_17,Added_Acitvity, net)
    petri_utils.add_arc_from_to(Added_Acitvity, p_18, net)
    ...
    petri_utils.add_arc_from_to( p_14,t_N2, net)
    petri_utils.add_arc_from_to(t_N2, p_10, net)
