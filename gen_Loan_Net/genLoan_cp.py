...
associatedTransitionName=['name_10','name_17','name_11']  ######################
...
def genNet():
    ...
    Check_credit_history2 = PetriNet.Transition("name_22", "Check_credit_history")
    Assess_loan_risk2 = PetriNet.Transition("name_23", "Assess_loan_risk")
    ...
    net.transitions.add(Check_credit_history2)
    net.transitions.add(Assess_loan_risk2)
    ...
    petri_utils.add_arc_from_to(Verify_repayment_agreement, p_17, net)
    petri_utils.add_arc_from_to(p_17,Check_credit_history2 , net)
    petri_utils.add_arc_from_to(Check_credit_history2, p_18, net)
    petri_utils.add_arc_from_to(p_18, Assess_loan_risk2, net)
    petri_utils.add_arc_from_to(Assess_loan_risk2, p_14, net)
