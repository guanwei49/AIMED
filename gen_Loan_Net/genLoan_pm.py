...
associatedTransitionName=['name_7','name_8','name_9','name_19']  ######################
...
def genNet():
    ...
    petri_utils.add_arc_from_to(p_12, t_N2, net)
    petri_utils.add_arc_from_to(t_N2, p_17, net)
    petri_utils.add_arc_from_to(t_N2, p_18, net)
    petri_utils.add_arc_from_to( p_17,Prepare_acceptance_pack, net)
    petri_utils.add_arc_from_to( p_18,Send_home_insurance_quote, net)
    petri_utils.add_arc_from_to( Prepare_acceptance_pack,p_19, net)
    petri_utils.add_arc_from_to( Send_home_insurance_quote, p_20,net)
    petri_utils.add_arc_from_to(p_19,t_N3, net)
    petri_utils.add_arc_from_to( p_20,t_N3, net)
    petri_utils.add_arc_from_to(t_N3, p_13, net)
    ...
    petri_utils.add_arc_from_to(p_9, Check_if_home_insurance_quote_is_requested, net)
