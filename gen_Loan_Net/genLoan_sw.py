...
associatedTransitionName=['name_7','name_8','name_10']  ######################
...
def genNet():
    ...
    petri_utils.add_arc_from_to(p_13, Prepare_acceptance_pack, net)
    ...
    petri_utils.add_arc_from_to(Check_if_home_insurance_quote_is_requested, p_14, net)
    ...
    petri_utils.add_arc_from_to(p_9, Verify_repayment_agreement, net)
    petri_utils.add_arc_from_to(Verify_repayment_agreement, p_12, net)
