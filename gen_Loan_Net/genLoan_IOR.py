...
associatedTransitionName=['name_15']  ######################
...
def genNet():
    ...
    Added_Acitvity = PetriNet.Transition("name_23", 'Added_Acitvity')
    ...
    petri_utils.add_arc_from_to(t_N2, p_18, net)
    petri_utils.add_arc_from_to(p_17, Added_Acitvity, net)
    petri_utils.add_arc_from_to(p_18, t_N3, net)
    petri_utils.add_arc_from_to(p_18, Reject_application, net)
    petri_utils.add_arc_from_to( t_N3,p_19, net)
    petri_utils.add_arc_from_to( Reject_application,p_19, net)
    petri_utils.add_arc_from_to(Added_Acitvity, p_20, net)
    petri_utils.add_arc_from_to(p_19, Loan_application_rejected, net)
    petri_utils.add_arc_from_to(p_20, Loan_application_rejected, net)
