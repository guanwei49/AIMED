...
path=os.path.join(ROOT_DIR,'data','Loanlogs')

if not os.path.exists(path):
    os.makedirs(path)

treepicName = "Loan_baseline_tree.png"
treeName = "Loan_baseline_tree.ptml"
netpicName = "Loan_baseline_petriNet.png"
netName = "Loan_baseline_petriNet.pnml"
